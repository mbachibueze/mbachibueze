...
export const HeroProjectCard: React.FC<HeroProjectCardProps> = ({project, onOpen}) => {
  ...
  return (
    <main className="w-full p-2 glass4 flex flex-col">
        ...
        <div className="relative w-full h-45 sm:h-78 lg:h-100 rounded-lg  overflow-hidden ">
          <Image
